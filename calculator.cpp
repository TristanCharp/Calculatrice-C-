...
string Calculator::calcule(string input)	// fonction de calcul par notation polonaise postfixée empile dépile
{
	float operande1;
	float operande2;
	float resultat;
...
void Calculator::postfix_eval(){
	...
	// 	//cout << buff << endl;
	// 	if(!this->calc_postfix->empty()){
	// 		this->calc_postfix->pop_front();
	// 	} 
